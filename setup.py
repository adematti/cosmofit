...
setup(name=package_basename,
      ...
      install_requires=['numpy', 'scipy', 'tabulate', 'mpytools @ git+https://github.com/adematti/mpytools', 'cosmoprimo @ git+https://github.com/adematti/cosmoprimo'],
      extras_require={'profilers': ['iminuit'], 'samplers': ['emcee', 'zeus-mcmc', 'dynesty', 'getdist'], 'emulators': ['tensorflow']},
