...
autodoc_mock_imports = ['imuinuit', 'emcee', 'zeus', 'dynesty', 'findiff', 'tensorflow']
...
git_repo = 'https://github.com/adematti/cosmofit.git'
git_root = 'https://github.com/adematti/cosmofit/blob/main/'
